  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center font-[family-name:var(--font-geist-sans)]">
      <main className="p-8 pb-20 flex flex-col items-center justify-center gap-6">
        ...
        <Link href="/welcome/overview" className="mt-4 text-sm font-bold text-gray-500 py-2 px-4 hover:underline">
          I&apos;ll do this later
        </Link>

        <h3 className="text-lg font-bold text-teal-800">Your data is secure.</h3>
        <h4>The sharing extension will never collect your personal data, history, or browsing information.</h4>
        <h4>It can only view the title and URL of a page when you click to share.</h4>
